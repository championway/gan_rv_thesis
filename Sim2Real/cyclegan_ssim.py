...
save_root = '/media/arg_ws3/5E703E3A703E18EB/research/sim2real/'
data_root = "/media/arg_ws3/5E703E3A703E18EB/data/sim2real_sample/"
root_A_train = os.path.join(data_root, "unity_totes_train.csv")
root_A_test = os.path.join(data_root, "unity_totes_test.csv")
root_B_train = os.path.join(data_root, "real_totes_train.csv")
root_B_test = os.path.join(data_root, "real_totes_test.csv")
